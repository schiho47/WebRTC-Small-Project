...
// let localStream;
// let remoteStream;
// const userOneVideo= document.querySelector('#user-1') as HTMLMediaElement; 
// const userTwoVideo = document.querySelector("#user-2") as HTMLMediaElement; 
// const offerSdp = document.getElementById("offer-sdp") as HTMLTextAreaElement;
// const answerSdp = document.getElementById("answer-sdp") as HTMLTextAreaElement;
// const APP_ID:string = "99553a9fb19c449c965e617e1b4e7486"; //Agora 提供之project id
...
// userOneVideo.srcObject = localStream;
// };
...
//     }
//     //在Dom render offer
//     offerSdp.value = JSON.stringify(message.offer);
...
//     answerSdp.value = JSON.stringify(
//       message.answer
//     );
//     addAnswer();
//   }
...
//   userTwoVideo.srcObject = remoteStream;
...
//     //-------??這裏track是localStream的片段，然後再傳一個完整的？-------//試試看不傳localStream會不會怎樣
//   });
...
//     if (event.candidate) {
//         const sdpTextarea = document.getElementById(
//           sdpType
//         ) as HTMLTextAreaElement;
//      sdpTextarea.value = JSON.stringify(peerConnection.localDescription);
